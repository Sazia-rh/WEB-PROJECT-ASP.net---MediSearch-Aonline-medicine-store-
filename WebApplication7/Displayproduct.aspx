<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Displayproduct.aspx.cs" Inherits="WebApplication7.Displayproduct" %>
    ...
    <asp:Label ID="Label4" runat="server" Text="MediSearch"></asp:Label>
     ...
     <div class="menu-bar">
        <ul>
            ...
            <li class="active"><a href="DisplayProduct.aspx">Medicines</a>
